...
public class FakeShoppingRepository implements GlobalShoppingRepository {
    ...
    @Override
    public void searchForImage(String searchQuery, String apikey, ResponseListener<List<ImageResponse>> responseListener) {
